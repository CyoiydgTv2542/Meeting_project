...
<head>
  ...
  <title>ระบบจองห้องประชุมมหาวิทยาลัยราชภัฏราชนครินท์</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="home" class="brand-link">
      <img src="{{ asset('dist/img/1.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">PondChyn</a>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
